...
!(function webpackUniversalModuleDefinition(root, factory) {
  ...
  if (window.location.href.match("https://pan.baidu.com/disk/main") !== null) {
    window.location.replace(
      "https://pan.baidu.com/disk/home?from=newversion&stayAtHome=true"
    );
  }
                ...
                option.url.indexOf("shuma") > -1 &&
                  ((head.Author =
                    ...
                    void 0 !== _b
                      ? _b
                      : "shuma"),
                  (head.Version = Config_1.Config.env.script.version)),
          ...
          return (
            ...
            (Options.systemInit = function () {
              $("#panparse-warning").hide(),
                $("#panparse-version").text(Config_1.Config.env.script.version),
                $("#panparse-title").text(
                  "[\u6570\u7801\u5c0f\u7ad9]\u8d85\u7ea7SVIP\u591a\u529f\u80fd\u5de5\u5177\u7bb1"
                );
            }),
